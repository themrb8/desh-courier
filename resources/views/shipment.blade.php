    ...
    <div class="flex">
            ...
            <div class="flex flex-col justify-between">
                <div class="menu ml-2 mb-8 p-4">
                    ...
                    <a href="" class="flex mt-4 ml-2">
                        <img src="{{asset('assets/img/active-shipment.svg')}}" alt="">
                        <span class="ml-2 font-bold text-primary">Shipments</span>
                    </a>
        ...
        <div class="w-full p-8 bg-gray-50">
            <div class="flex justify-between items-center">
                <div>
                    <h3 class="font-bold text-xl">Shipments</h3>
                    <p class="text-sm text-gray-500 mt-1">109 Orders Found</p>
                </div>
                ...
                <table class="w-full text-left border-separate border-spacing-y-3">
                    <thead class="py-6">
                      <tr class="bg-primary text-white">
                        ...
                        <th class="font-medium text-left py-2 px-4">Name</th>
                        <th class="font-medium text-left py-2 px-4">Address</th>
                        <th class="font-medium text-left py-2 px-4">Date</th>
                    ...
                    <tbody class="bg-white gap-4">
                      <tr>
                        ...
                        <td class="py-2 px-4">Bheramara, Kushtia, Khulna</td>
                        <td class="py-2 px-4">11-11-2023</td>
                        <td class="py-2 px-4">Bheramara</td>
                        <td class="py-2 px-4">
                            <div class="flex justify-between">
                                <div class="flex border border-gray-300 p-1 text-sm">
                                    <img src="{{asset('assets/img/tick-square.svg')}}" alt="" class="mr-1"> Delivered
                                </div>
                      ...
                      <tr>
                        ...
                        <td class="py-2 px-4">
                            <div class="flex justify-between">
                                <div class="flex border border-red-100 p-1 text-sm">
                                    <img src="{{asset('assets/img/close-square.svg')}}" alt="" class="mr-1"> Canceled
                                </div>
                                <img src="{{asset('assets/img/3more.svg')}}" alt="" class="ml-4">
                            </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="py-2 px-4">
                            <div class="flex justify-between">
                                <div class="flex border border-yellow-100 p-1 text-sm">
                                    <img src="{{asset('assets/img/table-setting.svg')}}" alt="" class="mr-1"> On Process
                                </div>
                                <img src="{{asset('assets/img/3more.svg')}}" alt="" class="ml-4">
                            </div>
                        </td>
