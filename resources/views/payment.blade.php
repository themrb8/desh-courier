<x-app-layout>
    ...
    <div class="flex">
            ...
            <div class="flex flex-col justify-between">
                <div class="menu ml-2 mb-8 p-4">
                    ...
                    <a href="{{route('payment')}}" class="flex mt-4 ml-2">
                        <img src="{{asset('assets/img/active-card.svg')}}" alt="">
                        <span class="ml-2 font-bold text-primary ">Payments</span>
                    </a>
        ...
        <div class="w-full p-8 bg-gray-50">
            <div class="w-full h-64 bg-white mb-10">
                Chart Area Reserved
            </div>
            <div class="flex justify-between items-center">
                <div>
                    <h3 class="font-bold text-xl">Payment History</h3>
                    <p class="text-sm text-gray-500 mt-1">June - 109 Payments Found</p>
                </div>
                ...
                <table class="w-full text-left border-separate border-spacing-y-3">
                    <thead class="py-6">
                      <tr class="bg-primary text-white">
                        ...
                        <th class="font-medium text-left py-2 px-4">Payment ID</th>
                        ...
                        <th class="font-medium text-left py-2 px-4">Amount</th>
                      </tr>
                    </thead>
                    <tbody class="bg-white gap-4">
                      <tr>
                        <td class="py-2 px-4">126802736</td>
                        <td class="py-2 px-4">#3573257326</td>
                        <td class="py-2 px-4">Ratul Ahmed</td>
                        <td class="py-2 px-4">11-01-2023</td>
                        <td class="py-2 px-4">Bkash</td>
                        <td class="py-2 px-4">
                            <div class="flex justify-between">
                                <div class="flex border border-green-400 px-2 text-sm text-green-400 font-bold">
                                    $509
                                </div>
