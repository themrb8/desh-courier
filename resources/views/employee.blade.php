            ...
            <div class="flex flex-col justify-between">
                ...
                <div class="menu ml-2 mb-8 p-4">
                    ...
                    <a href="{{route('employee')}}" class="flex ml-2">
                        <img src="{{asset('assets/img/active-user.svg')}}" alt="">
                        <span class="ml-2 text-primary font-bold">Employees</span>
                    </a>
        ...
        <div class="w-full p-8 bg-gray-50">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">109 ID Found</p>
                </div>
                ...
                <table class="w-full text-left border-separate border-spacing-y-3">
                    ...
                    <tbody class="bg-white gap-4">
                      ...
                      <tr>
                        <td class="py-2 px-4">126802736</td>
                        <td class="py-2 px-4">Ratul Ahmed</td>
                        <td class="py-2 px-4">Kushtia, Khulna</td>
                        <td class="py-2 px-4">Hub Manager</td>
                        <td class="py-2 px-4">Bheramara</td>
                        <td class="py-2 px-4">
                            <div class="flex justify-between">
                                <div class="flex border border-green-100 p-1 text-sm text-green-400">
                      ...
                      <tr>
                        ...
                        <td class="py-2 px-4">Ratul Ahmed</td>
                        <td class="py-2 px-4">Bheramara, Kushtia, Khulna</td>
                        <td class="py-2 px-4">Accountant</td>
                        <td class="py-2 px-4">Bheramara</td>
                        <td class="py-2 px-4">
                            <div class="flex justify-between">
